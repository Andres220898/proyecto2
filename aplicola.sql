...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-09-2023 a las 00:43:11
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `concatenarDireccion` (IN `documento` INT)   BEGIN
    SELECT CONCAT(localidad, ' ', barrio, ', ', ciudad, ' ', calle) AS nombre
    FROM domicilio_cliente
    WHERE registro_direccion IN (SELECT registro_direccion FROM cliente WHERE documento_cliente = documento);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `productosPorProveedor` (IN `n_proveedor` INT)   BEGIN
    SELECT producto.*
    FROM producto
    WHERE producto.n_proveedor = n_proveedor;
END$$
...
INSERT INTO `categoria_producto` (`id_categoria`, `nombre_categoria`, `unidad_medida`, `fyh_creacion`, `fyh_actualizacion`, `habilitado`) VALUES
(1, 'POLLO', 'LB', '2001-01-23 00:00:00', '2001-01-23 00:00:00', 'S'),
(2, 'PAVO', 'LB', '2001-01-23 00:00:00', '2001-01-23 00:00:00', 'S'),
(3, 'CERDO', 'LB', '2001-01-23 00:00:00', '2001-01-23 00:00:00', 'S'),
(4, 'LACTEOS', 'LB', '2001-01-23 00:00:00', '2001-01-23 00:00:00', 'S');
...
INSERT INTO `persona` (`documento`, `tipo_documento`, `primer_nombre`, `segundo_nombre`, `primer_apellido`, `segundo_apellido`, `correo`, `telefono`, `fyh_creacion`, `fyh_actualizacion`, `habilitado`) VALUES
(78965232, 'CC', 'Harrison', 'Stiven', 'Sierra', 'Rodriguez', 'HarrisonStivenSierra@gmail.co', 8297372, '2003-01-23 00:00:00', '2003-01-23 00:00:00', 'S'),
(79546872, 'CC', 'Valentina', 'Marcela', 'Caceres', 'Martinez', 'ValentinaMarcelaCaceres@gmail.co', 1234125, '2002-01-23 00:00:00', '2002-01-23 00:00:00', 'S'),
(84963251, 'CC', 'Juan', 'Felipe', 'Tellez', 'Vega', 'JuanFelipeTellez@gmail.co', 30897, '2020-06-23 00:00:00', '2028-06-23 00:00:00', 'S'),
(92658132, 'CC', 'Jerson', 'Duvan', 'Stick', 'Sanchez', 'JersonDuvanStick@gmail.co', 7091900, '2002-01-23 00:00:00', '2002-01-23 00:00:00', 'S'),
(764521036, 'CC', 'Jean', 'Carlos', 'Prieto', 'Martinez', 'JeanCarlosPrieto@gmail.co', 6199346, '2012-03-23 00:00:00', '2012-03-23 00:00:00', 'S'),
(1000003265, 'CC', 'Laura', 'Daniela', 'Rodriguez', 'Rodriguez', 'LauraDanielaRodriguez@gmail.co', 5882761, '2020-06-23 00:00:00', '2020-06-23 00:00:00', 'S'),
(1000036598, 'CC', 'Cindy', 'Juan', 'Bedoya', 'Mejia', 'CindyLorenaBedoya@gmail.co', 1741197, '2002-01-23 00:00:00', '2002-01-23 00:00:00', 'S'),
(1000107462, 'CC', 'David', 'Manuel', 'Perez', 'Garcia', 'DavidManuelPerez@gmail.co', 4010713, '2003-01-23 00:00:00', '2003-01-23 00:00:00', 'S'),
(1001077496, 'CC', 'Daniela', 'Valentina', 'Perez', 'Martinez', 'DanielaValentinaPerez@gmail.co', 7266237, '2001-01-23 00:00:00', '2002-01-23 00:00:00', 'S'),
(1001236598, 'CC', 'Lorena', 'Stefanya', 'Rodriguez', 'Guaqueta', 'LorenaStefanyaRodriguez@gmail.co', 7436177, '2012-03-23 00:00:00', '2012-03-23 00:00:00', 'S'),
(1001741963, 'CC', 'Jonathan', 'Alejandro', 'Dueñas', 'Velasquez', 'JonathanAlejandroDueñas@gmail.co', 1733333, '2030-01-23 00:00:00', '2030-01-23 00:00:00', 'S'),
(1002124578, 'CC', 'Johana', 'Stefania', 'Puerta', 'Niño', 'JohanaStefaniaPuerta@gmail.co', 5567780, '2001-01-23 00:00:00', '2001-01-23 00:00:00', 'S'),
(1002365478, 'CC', 'Alejandro', 'Stiven', 'Rodriguez', 'Rodriguez', 'AlejandroStivenRodriguez@gmail.co', 2426339, '2012-03-23 00:00:00', '2012-03-23 00:00:00', 'S'),
(1013215478, 'CC', 'Manuel', 'Alejandro', 'Mora', 'Garcia', 'ManuelAlejandroMora@gmail.co', 5462196, '2020-06-23 00:00:00', '2028-06-23 00:00:00', 'S'),
(4294967295, 'CC', 'Andrea', 'Esperanza', 'Bueno', 'Camargo', 'AndreaEsperanzaBueno@gmail.co', 5164070, '2001-01-23 00:00:00', '2002-01-23 00:00:00', 'S');
...
CREATE TABLE `producto` (
  ...
  `fyh_creacion` datetime DEFAULT NULL,
  `fyh_actualizacion` datetime DEFAULT NULL,
  `habilitado` char(2) DEFAULT NULL,
...
INSERT INTO `producto` (`n_producto`, `nombre_producto`, `precio_venta`, `precio_compra`, `fecha_caducidad`, `id_categoria`, `fyh_creacion`, `fyh_actualizacion`, `habilitado`, `n_proveedor`, `reg_date`) VALUES
(2, 'Hígado de pollo', 6000, 3000, '2023-04-20', NULL, '2001-01-23 00:00:00', '2002-01-23 00:00:00', '', 4, '2023-09-11 19:27:40'),
(3, 'Mollejas de pollo', 9000, 7000, '2023-05-30', NULL, '2012-03-23 00:00:00', '2012-03-23 00:00:00', 'S', 4, '2023-09-07 01:49:39'),
(4, 'Pechuga de pollo', 5000, 4500, '2023-05-01', NULL, '2020-06-23 00:00:00', '2028-06-23 00:00:00', 'S', 4, '2023-09-07 01:49:39'),
(5, 'Muslos de pollo', 16000, 11000, '2023-05-20', NULL, '2002-01-23 00:00:00', '2002-01-23 00:00:00', 'S', 4, '2023-09-07 01:49:39'),
(6, 'Pollo entero', 22000, 15000, '2023-04-28', NULL, '2003-01-23 00:00:00', '2003-01-23 00:00:00', 'S', 4, '2023-09-07 01:49:39'),
(7, 'pechuga de pavo', 10000, 5000, '2023-04-20', NULL, '2030-01-23 00:00:00', '2030-01-23 00:00:00', 'S', 4, '2023-09-07 01:49:39'),
(8, 'Cerdo en trozos', 24000, 20000, '2023-05-30', NULL, '2001-01-23 00:00:00', '2001-01-23 00:00:00', 'S', 1, '2023-09-07 01:49:39'),
(9, 'Chorizo', 16000, 12000, '2023-05-01', NULL, '2012-03-23 00:00:00', '2012-03-23 00:00:00', 'S', 2, '2023-09-07 01:49:39'),
(10, 'Salchichón', 24000, 20000, '2023-05-20', NULL, '2020-06-23 00:00:00', '2020-06-23 00:00:00', 'S', 3, '2023-09-07 01:49:39'),
(11, 'Jamón de cerdo', 20000, 18000, '2023-04-28', NULL, '2002-01-23 00:00:00', '2002-01-23 00:00:00', 'S', 2, '2023-09-07 01:49:39'),
(12, 'Queso campesino', 30000, 29000, '2023-04-20', NULL, '2003-01-23 00:00:00', '2003-01-23 00:00:00', 'S', 3, '2023-09-07 01:49:39'),
(13, 'Queso doble crema', 16000, 11000, '2023-05-30', NULL, '2001-01-23 00:00:00', '2002-01-23 00:00:00', 'S', 1, '2023-09-07 01:49:39'),
(14, 'Muslos de pavo', 20000, 16000, '2023-05-01', NULL, '2012-03-23 00:00:00', '2012-03-23 00:00:00', 'S', 2, '2023-09-07 01:49:39'),
(15, 'Jamon de pavo', 30000, 24000, '2023-05-20', NULL, '2020-06-23 00:00:00', '2028-06-23 00:00:00', 'S', 4, '2023-09-07 01:49:39'),
(16, 'Pavo entero', 10000, 7500, '2023-04-28', NULL, '2002-01-23 00:00:00', '2002-01-23 00:00:00', 'S', 3, '2023-09-07 01:49:39');
...
INSERT INTO `roles` (`id_rol`, `nombre_rol`, `fyh_creacion`, `fyh_actualizacion`, `habilitado`) VALUES
(1, 'Gerente', '2001-01-23 00:00:00', '2002-01-23 00:00:00', 'S'),
(2, 'Cliente', '2012-03-23 00:00:00', '2012-03-23 00:00:00', 'S'),
(3, 'Domiciliario', '2020-06-23 00:00:00', '2028-06-23 00:00:00', 'S');
...
INSERT INTO `usuarios` (`id_usuario`, `nombre_usuario`, `contraseña`, `documento`, `id_rol`, `fyh_creacion`, `fyh_actualizacion`, `habilitado`) VALUES
(1, 'valeperez1', 'perez123', 1001077496, 1, '2001-01-23 00:00:00', '2002-01-23 00:00:00', 'S'),
(2, 'srodrguez', 'stiven123', 1002365478, 2, '2012-03-23 00:00:00', '2012-03-23 00:00:00', 'S'),
(3, 'alejandrom', 'mora12', 1013215478, 2, '2020-06-23 00:00:00', '2028-06-23 00:00:00', 'S'),
(4, 'juanb4', 'bedoya04', 1000036598, 2, '2002-01-23 00:00:00', '2002-01-23 00:00:00', 'S'),
(5, 'perezm', 'manuel05', 1000107462, 2, '2003-01-23 00:00:00', '2003-01-23 00:00:00', 'S'),
(6, 'alejodueñas', 'alejadro06', 1001741963, 2, '2030-01-23 00:00:00', '2030-01-23 00:00:00', 'S'),
(7, 'stafepuertas', 'puetas132', 1002124578, 2, '2001-01-23 00:00:00', '2001-01-23 00:00:00', 'S'),
(8, 'orenar08', 'loren89', 1001236598, 2, '2012-03-23 00:00:00', '2012-03-23 00:00:00', 'S'),
(9, 'daniel09 ', 'dani21', 1000003265, 2, '2020-06-23 00:00:00', '2020-06-23 00:00:00', 'S'),
(10, 'marcaceres', 'caceres10', 79546872, 2, '2002-01-23 00:00:00', '2002-01-23 00:00:00', 'S'),
(11, 'stiven123', 'sierra11', 78965232, 2, '2003-01-23 00:00:00', '2003-01-23 00:00:00', 'S'),
(12, 'buenoespe', 'bueno132', 4294967295, 2, '2001-01-23 00:00:00', '2002-01-23 00:00:00', 'S'),
(13, 'carlos12', 'prieto12', 764521036, 3, '2012-03-23 00:00:00', '2012-03-23 00:00:00', 'S'),
(14, 'felipete', 'tellez14', 84963251, 3, '2020-06-23 00:00:00', '2028-06-23 00:00:00', 'S'),
(15, 'duvan12', 'sanchez12', 92658132, 3, '2002-01-23 00:00:00', '2002-01-23 00:00:00', 'S');
...
--
ALTER TABLE `producto`
  MODIFY `n_producto` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `detalle_venta`
  ADD CONSTRAINT `detalle_venta_ibfk_2` FOREIGN KEY (`n_producto`) REFERENCES `producto` (`n_producto`) ON DELETE CASCADE;
...
--
ALTER TABLE `producto`
  ADD CONSTRAINT `n_proveedor` FOREIGN KEY (`n_proveedor`) REFERENCES `proveedor` (`n_proveedor`),
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`documento`) REFERENCES `persona` (`documento`),
  ADD CONSTRAINT `usuarios_ibfk_2` FOREIGN KEY (`id_rol`) REFERENCES `roles` (`id_rol`);

--
-- Filtros para la tabla `vehiculo_domiciliario`
--
ALTER TABLE `vehiculo_domiciliario`
  ADD CONSTRAINT `vehiculo_domiciliario_ibfk_1` FOREIGN KEY (`n_domiciliario`) REFERENCES `domiciliario` (`n_domiciliarion`);
COMMIT;
